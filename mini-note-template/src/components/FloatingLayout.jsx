// src/components/FloatingLayout.jsx — radial-gradient page background +
// frosted card container. Pass `wide` for slightly wider screens (e.g.
// signup).
const { Box, Paper } = window.MUI;

function FloatingLayout({ mode, wide, children }) {
  return (
    <Box sx={{
...
window.FloatingLayout = FloatingLayout;
